...
import { Dialog, DialogPanel, Transition, Menu, Popover } from '@headlessui/react'
      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            ...
            {/* Company regular link - no dropdown */}
            <a href="404" className="text-sm/6 font-semibold text-gray-900">
              Company
            </a>
                ...
                <Popover.Panel className="absolute left-1/2 z-10 mt-3 w-screen max-w-xs -translate-x-1/2 transform px-2 sm:px-0">
                  <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                    <div className="relative grid gap-6 bg-white p-6">
                      <a href="#" className="flex items-center rounded-lg p-2 hover:bg-gray-50">
                        <div className="ml-3 text-sm font-medium text-gray-900">Documentation</div>
                      </a>
                      <a href="#" className="flex items-center rounded-lg p-2 hover:bg-gray-50">
                        <div className="ml-3 text-sm font-medium text-gray-900">API Reference</div>
                      </a>
                    </div>
                  </div>
                </Popover.Panel>
